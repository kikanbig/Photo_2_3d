...
## 🎉 Версия 3.2 - Полная система аутентификации с кредитами
...
![Photo to 3D](https://img.shields.io/badge/Status-Stable%203.2-brightgreen) ![Node.js](https://img.shields.io/badge/Node.js-18+-green) ![React](https://img.shields.io/badge/React-18+-blue) ![PostgreSQL](https://img.shields.io/badge/PostgreSQL-Required-blue)
...
### 🎮 Расширенные функции
- 🔐 **Система аутентификации** - регистрация, логин, email подтверждение
- 💰 **Кредитная система** - 100 бесплатных кредитов при регистрации
...
- 📚 **Личная коллекция** - модели пользователя с превью изображений
...
### Authentication & Credits (JWT + PostgreSQL)
```mermaid
graph TB
    ...
    E --> F[Credit Deduction: -1]
    F --> G[Personal Models Collection]
```
...
### Генерация 3D модели (требует аутентификации)
```http
...
**Требования:** 1 кредит, подтвержденный email

---

## 🎫 Система кредитов

- **Стартовый баланс:** 100 кредитов при регистрации
- **Стоимость генерации:** 1 кредит за модель
- **Проверка баланса:** Автоматическая перед каждой операцией
- **Отображение:** В профиле пользователя и интерфейсе
...
# Аутентификация (ОБЯЗАТЕЛЬНО для регистрации)
JWT_SECRET=your-super-secret-jwt-key-here

# Email настройки (ОБЯЗАТЕЛЬНО для отправки подтверждений)
...
Для отправки email подтверждений:

1. **Включите двухфакторную аутентификацию** в аккаунте Gmail
2. **Создайте App Password:**
   - Перейдите в [Google Account Settings](https://myaccount.google.com/security)
   - В разделе "Security" → "Signing in to Google" → "App passwords"
