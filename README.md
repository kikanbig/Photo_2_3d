...
![Photo to 3D](https://img.shields.io/badge/Status-Stable%203.0-brightgreen) ![Node.js](https://img.shields.io/badge/Node.js-18+-green) ![React](https://img.shields.io/badge/React-18+-blue) ![PostgreSQL](https://img.shields.io/badge/PostgreSQL-Required-blue)
...
- 📚 **Управление коллекцией** - список всех созданных моделей
